...
const product = {
  ...
  images: [
    {
      src: '/pdl3.png',
      alt: 'Imagen del pastel de dulce de leche.',
    },
    {
      src: '/pdl.png',
      alt: 'Otra vista del pastel de dulce de leche.',
    },
    {
      src: '/pdl1.png',
      alt: 'Pastel de dulce de leche desde otra perspectiva.',
    },
    {
      src: '/pdl2.png',
      alt: 'Vista adicional del pastel de dulce de leche.',
    },
  ],
  sizes: [
  ...
  description: 'Este pastel en la parte superior tiene pastel de tres leches y la parte de abajo flan, relleno de mermelada de fresa y nuez, cubierto con betún de crema y decorado con fruta de temporada.',
  highlights: [
    'Hecho a mano',
  ...
  details: {
    ...
    decoration: 'Decorado con fruta de temporada.',
    sizes: [
  ...
  testimonials: [
    {
      name: 'Ana Gómez',
      review: 'El pastel de dulce de leche más delicioso que he probado. Perfecto para cualquier ocasión.',
    },
    {
      name: 'Luis Martínez',
      review: 'La combinación de tres leches y flan es simplemente perfecta. Muy recomendado.',
    },
    {
      name: 'Sofía Rodríguez',
      review: 'Fresco, delicioso y con ingredientes de alta calidad. Definitivamente lo volveré a comprar.',
    },
  ],
};
const reviews = { href: '#', average: 4.7, totalCount: 150 };
