...
const product = {
  ...
  images: [
    {
      src: '/pby1.png',
      alt: 'Imagen del pastel de Baylis.',
    },
    {
      src: '/pby2.png',
      alt: 'Otra vista del pastel de Baylis.',
    },
    {
      src: '/pby3.png',
      alt: 'Pastel de Baylis desde otra perspectiva.',
    },
    {
      src: '/pby4.png',
      alt: 'Vista adicional del pastel de Baylis.',
    },
  ],
  sizes: [
  ...
  description: 'Pastel de Baylis: Un pastel con un toque de licor Baylis, ideal para quienes buscan un sabor único y sofisticado.',
  highlights: [
    'Hecho a mano',
    'Ingredientes frescos',
    'Sabor sofisticado y delicioso',
  ],
  details: {
    ingredients: [
      'Pan de vainilla',
      'Crema de Baylis',
      'Betún de Baylis',
      'Decoración de Baylis',
    ],
    decoration: 'Decorado con crema de Baylis y chocolate rallado.',
    sizes: [
  ...
  testimonials: [
    {
      ...
      review: 'Un pastel con un sabor espectacular, perfecto para los amantes del Baylis.',
    },
    {
      name: 'Raúl Fernández',
      review: 'El pastel ideal para cualquier ocasión especial, muy recomendable.',
    },
    {
      name: 'Carmen Sánchez',
      review: 'Delicioso y con un toque especial de Baylis, todos lo disfrutaron.',
    },
  ],
};
const reviews = { href: '#', average: 4.7, totalCount: 78 };
