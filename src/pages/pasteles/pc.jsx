...
const product = {
  ...
  images: [
    {
      src: '/pc5.png',
      alt: 'Imagen del pastel de cajeta.',
    },
    {
      src: '/pc1.png',
      alt: 'Otra vista del pastel de cajeta.',
    },
    {
      src: '/pc2.png',
      alt: 'Pastel de cajeta desde otra perspectiva.',
    },
    {
      src: '/pc3.png',
      alt: 'Vista adicional del pastel de cajeta.',
    },
  ],
  sizes: [
  ...
  description: 'Pan de vainilla bañado con crema de cajeta, relleno de nuez y fresa natural. Decorado con betún de cajeta y fruta de la temporada.',
  highlights: [
    'Hecho a mano',
  ...
  details: {
    ...
    decoration: 'Decorado con betún de cajeta y fruta de la temporada.',
    sizes: [
  ...
  testimonials: [
    {
      name: 'Juan Pérez',
      review: 'El mejor pastel de cajeta que he probado, realmente delicioso y fresco.',
    },
    {
      name: 'María López',
