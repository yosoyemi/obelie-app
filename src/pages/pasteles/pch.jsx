...
const product = {
  ...
  images: [
    {
      src: '/pch1.png',
      alt: 'Imagen del pastel Delirio de Chocolate.',
    },
    {
      src: '/pch2.png',
      alt: 'Otra vista del pastel Delirio de Chocolate.',
    },
    {
      src: '/pch3.png',
      alt: 'Pastel Delirio de Chocolate desde otra perspectiva.',
    },
    {
      src: '/pch4.png',
      alt: 'Vista adicional del pastel Delirio de Chocolate.',
    },
  ],
  sizes: [
  ...
  description: 'Pastel Delirio de Chocolate: Tres capas de pastel de mantequilla de chocolate blanco, oscuro y amargo, ligeramente húmedo. Entre cada capa tiene crema de avellana y por fuera está cubierto con una capa de chocolate crujiente. Decorado con fruta de temporada para un toque final irresistible.',
  highlights: [
    'Hecho a mano',
  ...
  details: {
    ingredients: [
      'Pastel de mantequilla de chocolate blanco',
      'Pastel de mantequilla de chocolate oscuro',
      'Pastel de mantequilla de chocolate amargo',
      'Crema de avellana',
      'Capa de chocolate crujiente',
      'Fruta de temporada',
    ],
    decoration: 'Decorado con fruta de temporada para un toque final irresistible.',
    sizes: [
  ...
  testimonials: [
    {
      name: 'Luis Martínez',
      review: 'El mejor pastel de chocolate que he probado, realmente delicioso y fresco.',
    },
    {
      name: 'María García',
      review: 'Perfecto para celebraciones, a todos les encantó el sabor intenso.',
    },
    {
      name: 'Andrés Torres',
      review: 'La combinación de chocolates es perfecta, definitivamente lo recomiendo.',
    },
  ],
};
const reviews = { href: '#', average: 4.9, totalCount: 120 };

function classNames(...classes) {
  return classes.filter(Boolean).join(' ');
}

export default function PDCH() {
