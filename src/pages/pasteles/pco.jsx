...
const product = {
  ...
  images: [
    {
      src: '/pco4.png',
      alt: 'Imagen del pastel de Coco.',
    },
    {
      src: '/pco2.png',
      alt: 'Otra vista del pastel de Coco.',
    },
    {
      src: '/pco3.png',
      alt: 'Pastel de Coco desde otra perspectiva.',
    },
    {
      src: '/pco1.png',
      alt: 'Vista adicional del pastel de Coco.',
    },
  ],
  sizes: [
  ...
  description: 'Pastel de Coco: Pan de vainilla de mantequilla, ligeramente bañado con crema de coco, relleno de almendra y cubierto con betún de coco. Decorado con coco natural y cerezas para un toque final delicioso.',
  highlights: [
    'Hecho a mano',
    'Ingredientes frescos',
    'Sabor tropical y refrescante',
  ],
  details: {
    ingredients: [
      'Pan de vainilla de mantequilla',
      'Crema de coco',
      'Almendra',
      'Betún de coco',
      'Coco natural',
    ...
    decoration: 'Decorado con coco natural y cerezas para un toque final delicioso.',
    sizes: [
  ...
  testimonials: [
    {
      name: 'Laura Gómez',
      review: 'El mejor pastel de coco que he probado, realmente delicioso y fresco.',
    },
    {
      name: 'José Martínez',
      review: 'Perfecto para celebraciones, a todos les encantó el sabor tropical.',
    },
    {
      name: 'Ana Sánchez',
...
const reviews = { href: '#', average: 4.6, totalCount: 105 };

function classNames(...classes) {
  return classes.filter(Boolean).join(' ');
}

export default function PCO() {
