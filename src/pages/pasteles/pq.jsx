...
const product = {
  ...
  images: [
    {
      src: '/pq2.png',
      alt: 'Imagen del pastel de Quesopiña.',
    },
    {
      src: '/pq.png',
      alt: 'Otra vista del pastel de Quesopiña.',
    },
    {
      src: '/pq.png',
      alt: 'Pastel de Quesopiña desde otra perspectiva.',
    },
    {
      src: '/pq4.png',
      alt: 'Vista adicional del pastel de Quesopiña.',
    },
  ],
  sizes: [
  ...
  description: 'Pan de vainilla de mantequilla, relleno de nuez y cubierto con un delicioso betún de queso y trocitos de Piña.',
  highlights: [
    'Hecho a mano',
    'Ingredientes frescos',
    'Sabor dulce y frutal',
  ],
  details: {
    ingredients: [
      'Pan de vainilla',
  ...
  testimonials: [
    {
      name: 'Juan Pérez',
      review: 'El mejor pastel de Quesopiña que he probado, realmente delicioso y fresco.',
    },
    {
      name: 'María López',
