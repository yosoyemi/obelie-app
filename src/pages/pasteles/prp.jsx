...
const product = {
  ...
  images: [
    {
      src: '/prp1.png',
      alt: 'Imagen del pastel de Rompope.',
    },
    {
      src: '/prp2.png',
      alt: 'Otra vista del pastel de Rompope.',
    },
    {
      src: '/prp3.png',
      alt: 'Pastel de Rompope desde otra perspectiva.',
    },
    {
      src: '/prp4.png',
      alt: 'Vista adicional del pastel de Rompope.',
    },
  ],
  sizes: [
  ...
  description: 'Pastel de Rompope: Un delicioso bizcocho de vainilla bañado en rompope, relleno de almendra y cubierto con un exquisito betún de rompope. Decorado con amaranto dorado y un toque de cereza para un final perfecto.',
  highlights: [
    'Hecho a mano',
    'Ingredientes frescos',
    'Sabor tradicional y exquisito',
  ],
  details: {
    ingredients: [
    ...
    decoration: 'Decorado con amaranto dorado y un toque de cereza para un final perfecto.',
    sizes: [
  ...
  testimonials: [
    {
      ...
      review: 'Un pastel delicioso, el rompope le da un sabor único.',
    },
    {
      name: 'Roberto Fernández',
      review: 'Ideal para cualquier ocasión, a todos les encantó.',
    },
    {
      name: 'Lucía Ramírez',
      review: 'La combinación de sabores es perfecta, definitivamente lo recomiendo.',
    },
  ],
};
const reviews = { href: '#', average: 4.7, totalCount: 102 };
