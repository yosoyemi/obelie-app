...
const product = {
  ...
  images: [
    {
      src: '/psn1.png',
      alt: 'Imagen del pastel Selva Negra.',
    },
    {
      src: '/psn2.png',
      alt: 'Otra vista del pastel Selva Negra.',
    },
    {
      src: '/psn3.png',
      alt: 'Pastel Selva Negra desde otra perspectiva.',
    },
    {
      src: '/psn4.png',
      alt: 'Vista adicional del pastel Selva Negra.',
    },
  ],
  sizes: [
  ...
  description: 'Pastel Selva Negra: Pan de chocolate de mantequilla ligeramente húmedo con jugo de cereza y dos rellenos deliciosos, uno de nuez y otro de cereza. Su decoración varía con fruta de temporada, chocolate y cereza, creando una combinación perfecta de sabores y texturas.',
  highlights: [
    'Hecho a mano',
    'Ingredientes frescos',
    'Sabor rico y delicioso',
  ],
  details: {
    ingredients: [
      'Pan de chocolate de mantequilla',
      'Jugo de cereza',
      'Relleno de nuez',
      'Relleno de cereza',
      'Fruta de temporada',
    ...
    decoration: 'Decorado con fruta de temporada, chocolate y cereza, creando una combinación perfecta de sabores y texturas.',
    sizes: [
  ...
  testimonials: [
    {
      name: 'Patricia Gómez',
      review: 'El mejor pastel de Selva Negra que he probado, realmente delicioso y fresco.',
    },
    {
      name: 'Juan Torres',
    ...
    {
      name: 'Marta López',
      review: 'La combinación de ingredientes es perfecta, definitivamente lo recomiendo.',
    },
  ],
};
const reviews = { href: '#', average: 4.8, totalCount: 115 };
