...
const product = {
  ...
  images: [
    {
      src: '/pte4.png',
      alt: 'Imagen del pastel de Tequila.',
    },
    {
      src: '/pte2.png',
      alt: 'Otra vista del pastel de Tequila.',
    },
    {
      src: '/pte3.png',
      alt: 'Pastel de Tequila desde otra perspectiva.',
    },
    {
      src: '/pte1.png',
      alt: 'Vista adicional del pastel de Tequila.',
    },
  ],
  sizes: [
  ...
  description: 'Pastel de Tequila: Pan de vainilla bañado con una rica crema de tequila, relleno de almendra y cubierto con un delicioso betún de crema. Decorado con cereza para un toque final perfecto.',
  highlights: [
    'Hecho a mano',
  ...
  details: {
    ...
    decoration: 'Decorado con cereza para un toque final perfecto.',
    sizes: [
  ...
  testimonials: [
    {
      ...
      review: 'Un pastel con un sabor increíble, el toque de tequila es perfecto.',
    },
    {
      name: 'Sofía López',
      review: 'Ideal para celebraciones, a todos les encantó.',
    },
    {
      name: 'Carlos Hernández',
      review: 'El pastel más delicioso que he probado, lo recomiendo totalmente.',
    },
  ],
};
const reviews = { href: '#', average: 4.8, totalCount: 97 };
