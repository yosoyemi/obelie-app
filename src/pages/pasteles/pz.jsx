...
const product = {
  ...
  images: [
    {
      src: '/pz1.png',
      alt: 'Imagen del pastel de zanahoria.',
    },
    {
      src: '/pz.png',
      alt: 'Otra vista del pastel de zanahoria.',
    },
    {
      src: '/pz2.png',
      alt: 'Pastel de zanahoria desde otra perspectiva.',
    },
    {
      src: '/pz3.png',
      alt: 'Vista adicional del pastel de zanahoria.',
    },
  ],
  sizes: [
  ...
  description: 'Pan de mantequilla realizado con harina refinada, lleva pasas, Piña en almíbar, canela, nuez y zanahoria. Se puede hacer con azúcar normal o con stevia. El relleno y la cubierta es con betún de crema. Decorado con fruta de temporada.',
  highlights: [
    'Hecho a mano',
  ...
  testimonials: [
    {
      name: 'Juan Pérez',
      review: 'El mejor pastel de zanahoria que he probado, realmente delicioso y fresco.',
    },
    {
      name: 'María López',
